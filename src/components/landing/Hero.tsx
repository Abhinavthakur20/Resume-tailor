...
export default function Hero() {
  return (
    <section className="pt-32 pb-24 px-6 bg-linear-to-b from-neutral-50 to-white overflow-hidden">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        {/* Left Column - Headline & CTA */}
        <div className="lg:col-span-6 text-left space-y-6 animate-fade-up">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[54px] font-extrabold text-neutral-900 leading-[1.1] tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <Link href="/app/workspace"
              className="inline-flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-white font-semibold px-8 py-3.5 rounded-lg text-base transition-all shadow-md active:scale-95 cursor-pointer">
          ...
          {/* Ratings */}
          <div className="pt-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 text-sm text-neutral-400">
            <div className="flex items-center gap-1">
              ...
              <span className="ml-1 text-neutral-500 font-semibold">4.9/5 from 2,000+ users</span>
            </div>
        ...
        <div className="lg:col-span-6 relative w-full flex justify-center lg:justify-end animate-fade-up">
          <div className="w-full max-w-lg bg-neutral-900 rounded-2xl p-4 shadow-2xl flex flex-col gap-3 overflow-hidden border border-neutral-800">
            {/* Mock Window Header */}
            <div className="flex items-center justify-between border-b border-neutral-800 pb-2.5">
              ...
              <div className="text-[10px] text-neutral-500 font-medium font-mono px-2 py-0.5 bg-neutral-800 rounded">workspace.tex</div>
              <div className="w-12" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
              {/* LaTeX Editor Panel */}
              <div className="md:col-span-6 bg-neutral-950 rounded-xl p-3 flex flex-col gap-2 border border-neutral-800/80 select-none">
                <div className="text-[9px] font-bold text-neutral-500 uppercase tracking-wider">LaTeX Source</div>
                <div className="font-mono text-[9px] text-neutral-400 space-y-1 leading-normal overflow-hidden h-[180px]">
                  ...
                  {/* Diff Lines */}
                  <div className="pl-3 text-red-400 font-semibold bg-red-950/40 rounded px-1 py-0.5 line-through decoration-red-500/50">
                    - Designed backend services.
                  </div>
                  <div className="pl-3 text-emerald-400 font-semibold bg-emerald-950/40 rounded px-1 py-0.5">
                    + Built REST APIs with Next.js, TypeScript & Tailwind CSS.
                  </div>

                  <div className="pl-3 text-red-400 font-semibold bg-red-950/40 rounded px-1 py-0.5 line-through decoration-red-500/50 mt-1">
              ...
              {/* ATS Checker Panel */}
              <div className="md:col-span-6 bg-neutral-950 rounded-xl p-3 flex flex-col justify-between border border-neutral-800/80 select-none">
                <div>
