          ...
          activeTab === "upload" ? (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-neutral-400 mt-1">Accepts .tex or .txt files</p>
              </div>
            ...
            <div className="flex-1 min-h-[350px] rounded-xl bg-white border border-neutral-200 flex flex-col overflow-hidden transition-all focus-within:border-primary-500 focus-within:ring-2 focus-within:ring-primary-500/10">
              <textarea
                ...
                className="flex-1 p-4 bg-transparent resize-none font-mono text-[13px] leading-relaxed text-neutral-800 placeholder:text-neutral-400"
                placeholder="Paste your LaTeX resume code here..."
                spellCheck={false}
              />
              <div className="px-4 py-2 bg-neutral-50 border-t border-neutral-100 flex items-center justify-end text-[11px] text-neutral-400 font-mono">
                0 chars
              </div>
            </div>
          )
